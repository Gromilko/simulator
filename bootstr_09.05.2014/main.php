        ...
        <div class="row">
            ...
            <div class="span6">
				...
				<?php if($_SESSION['login'] == 'admin'){?>
					<form id="save" action="admin.php">
						<button  type="submit" class="btn btn-info pull-right">Админпанель</button>
					</form>
				<?php }?>
...
<script type="text/javascript">
        $(function() {
            $("#save").submit(function() {
                ...
                var formData = {
                    "mood":document.getElementById("mood").children[0].style.width,
                    "hp":document.getElementById("hp").children[0].style.width,
                    "eat":document.getElementById("eat").children[0].style.width,
                    "xp":document.getElementById("xp").children[0].style.width,
                    "rubles":$("#rubles").val(),
                    "ye":$("#ye").val(),
                };
                $.ajax({
